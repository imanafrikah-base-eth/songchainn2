...
// Stream counts are not computed here any more. A song's count is the row in
// song_stream_history (the numbers the catalogue carried on 6 September 2026,
// frozen into the database) plus every real play recorded in song_analytics,
// summed once in get_song_popularity(). Nothing in the bundle seeds a number.
