...
type Action = { type: "flow"; flow: "upload_song" | "build_world" | "edit_world" | "edit_gallery" | "become_artist" | "connect_wallet" } | { type: "go"; path: string };

const FLOWS = new Set(["upload_song", "build_world", "edit_world", "edit_gallery", "become_artist", "connect_wallet"]);
