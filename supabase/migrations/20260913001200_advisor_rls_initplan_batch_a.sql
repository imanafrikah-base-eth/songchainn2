-- Performance advisor: auth_rls_initplan, batch A (account_* .. content_reports).
...
do $mig$
declare
  tbls text[] := array['account_actions','account_appeals','account_links','artist_accounts','artist_applications','artist_claims','artist_coins','artist_media','artist_verification_requests','artist_wallets','audience_profiles','battle_host_fees','battle_room_messages','battle_rooms','battle_speaker_requests','battle_trades','battle_voice_fees','battle_votes','battle_winner_payouts','battles','bug_reports','comment_likes','content_reports'];
