-- Performance advisor: auth_rls_initplan, batch B (direct_messages .. room_profiles).
...
do $mig$
declare
  tbls text[] := array['direct_messages','dm_coin_access','dm_conversations','dm_messages','dm_participants','dm_threads','farcaster_identities','liked_artists','liked_songs','message_reports','phase_two_beta_reports','playlist_collaborators','playlist_songs','playlists','policy_acceptances','post_comments','post_likes','post_tags','referral_codes','referrals','releases','room_messages','room_profiles'];
